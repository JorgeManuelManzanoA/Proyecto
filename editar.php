...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sentencia = $bd->prepare("UPDATE pacientes SET nombres = ?, apellido_paterno = ?, apellido_materno = ?, seguro_medico = ?,
...
<div style="max-width: 420px; margin: 72px auto; border-radius: 5px; font-family: Arial, sans-serif; background-color: #f5f5f5;
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?codigo=' . $codigo); ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtApMaterno" autofocus required value="<?php echo $persona->apellido_materno; ?>">
        </div>
        <div class="mb-3">
            <label style="display: block; font-weight: bold; color: #292929; margin-bottom: 5px;">Seguro Medico: </label>
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtSegMedico" autofocus required value="<?php echo $persona->seguro_medico; ?>">
        </div>
        <div class="mb-3">
            <label style="display: block; font-weight: bold; color: #292929; margin-bottom: 5px;">Genero: </label>
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtGenero" autofocus required value="<?php echo $persona->genero; ?>">
        </div>
        <div class="mb-3">
            <label style="display: block; font-weight: bold; color: #292929; margin-bottom: 5px;">Celular: </label>
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtCelular" autofocus required value="<?php echo $persona->celular; ?>">
        </div>
        <div class="mb-3">
            <label style="display: block; font-weight: bold; color: #292929; margin-bottom: 5px;">Direccion: </label>
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtDireccion" autofocus required value="<?php echo $persona->direccion; ?>">
        </div>
        <div class="mb-3">
            <label style="display: block; font-weight: bold; color: #292929; margin-bottom: 5px;">Estado: </label>
            <input type="text" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; width: 95%; margin-bottom: 10px;" 
                class="form-control" name="txtEstado" autofocus required value="<?php echo $persona->estado; ?>">
        </div>
        ...
        <div class="d-grid">
            <input type="submit" style="padding: 10px; border-radius: 5px; border: none; background-color: #007bff; color: #fff; 
                width: 100%; margin-bottom: 10px; cursor: pointer; font-size:14px" class="btn btn-primary" value="Editar">
        </div>
    </form>
</div>
</body>
