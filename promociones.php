    ...
    <div style="width 100%; display: inline-flex;">
        <div style="margin: 0 auto; padding: 0px; width: 40%;">
            <div style="background-color: #f5f5f5; margin:40px;  border-radius: 5px; padding: 20px;">
                ...
                <button type="submit" class="btn btn-secondary" style="padding: 10px; border-radius: 5px; border: none; background-color: #007bff; color: #fff; width: 88%; margin-bottom: 10px; cursor: pointer; font-size:14px">
